function bgChange() {
	if(this.scrollY > this.innerHeight / 4 && this.scrollY < this.innerHeight/ 2 + 500){
	...
	else if(this.scrollY > this.innerHeight/2 + 500 && this.scrollY < 3 * this.innerHeight/ 4 + 1000){
		console.log(this.innerHeight + "2");
		document.body.classList.add("activebg2");
		document.body.classList.remove("activebg");
		document.body.classList.remove("activebg3");
	}
	else if(this.scrollY > 3 * this.innerHeight/ 4 + 1000){
